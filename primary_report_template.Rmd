...
params:
  ...
  school: 
    ...
    input: select
    value: "037"
    choices: ["024","066","063","071","062","072","036"]
...
```{r covid_girls, fig.cap="Perceived impact of the COVID-19 pandemic on GIRLS", fig.height=4.2, fig.width=6.4}
school_dat |>
  bar_diverging("Girls")
```


```{r covid_boys, fig.cap="Perceived impact of the COVID-19 pandemic on BOYS", fig.height=4.2, fig.width=6.4}
school_dat |>
  bar_diverging("Boys")
```

```{r covid_all, fig.cap="Perceived impact of the COVID-19 pandemic on all pupils", fig.height=4.2, fig.width=6.4}
school_dat |>
