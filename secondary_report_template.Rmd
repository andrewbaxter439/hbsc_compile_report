...
"S2083", "S2010", "S2022", "S2024", "S2028", "S2033", 
...
```{r tab.cap="Overview of survey respondents", tab.id = "mytab", tab.cap.style = "Caption"}
...
bar_by_cat(leftout, c("Often", "Always"), .censor = FALSE)
```
...
bar_by_cat(confidence, c("Often", "Always"), .censor = FALSE)
```
...
bar_by_cat(happiness, c("I feel quite happy", "I feel very happy"), .censor = FALSE)
```
