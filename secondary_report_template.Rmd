...
```{r substance_gender, fig.cap="% pupils who reported substance use in their lifetime, by gender"}
school_dat |> 
...
```{r substance_grade, fig.cap="% pupils who reported substance use in their lifetime, by year group"}
school_dat |> 
  bar_multiple_vars(list(
  drunk1life = "Been drunk",
  smokever = "Tried tobacco",
