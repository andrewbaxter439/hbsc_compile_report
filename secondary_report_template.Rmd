...
school_dat |> count(sex, grade) |> 
  ...
  rename(" " = sex) |> 
  mutate(across(2:3, ~formatC(.x, width = 6))) |> 
  knitr::kable()
```
...
In your school, `r perc_success(EMC_Problem, "Problematic social media user")` of all pupils surveyed scored as problematic social media users.
