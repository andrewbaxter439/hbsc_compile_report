...
```{r tab_n_pupils, tab.cap="Overview of survey respondents", tab.id = "n_pupils", tab.cap.style = "Caption", eval = TRUE, table.conditional.last_row = TRUE, tab.last_column = TRUE, label = 'tab1'}
school_summary <- school_dat |>
  count(sex, grade) |> 
...
include_subs_split <- test_bar_multiple_vars(school_dat, subs_use_vars)
