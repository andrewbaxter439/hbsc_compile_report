...
[`r ifelse(is.null(params$school_name), params$school, params$school_name)`]
:::
...
<!-- -   Received mean comments about weight -- `r perc_success(school_dat, Bully_, "Bullied 2-3 times+")`% -->
