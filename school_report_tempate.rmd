...
<!-- ![](images/SHINE_logo.png){width=100%} -->


```{r, out.width=1200}
knitr::include_graphics('images/SHINE_logo.png')
```
...
```{r, out.width=300}
knitr::include_graphics('images/hbsc_logo.png')
```


```{r, out.width=1200}
knitr::include_graphics('images/SPHSU_logo.png')
```
